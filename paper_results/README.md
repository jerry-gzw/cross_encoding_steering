...
This directory contains compact copies of the tables and figures reported in
...
- `appendix_letter_permutation_by_contrast.csv`
- `appendix_interface_factorial_baseline_by_model.csv`
- `appendix_interface_factorial_identifier_vocabulary.csv`
...
- `appendix_central_group_cluster_inventory.csv`
- `appendix_factorial_group_cluster_bootstrap_ci.csv`
- `appendix_factorial_competence_conditioned_attribution.csv`
- `appendix_factorial_competence_conditioned_by_model.csv`
- `appendix_factorial_competence_conditioned_group_cluster_ci.csv`
- `appendix_factorial_competence_subset_inventory.csv`
- `appendix_interface_factorial_key_competence_summary.csv`
- `appendix_interface_factorial_six_mapping_competence.csv`
...
- `appendix_group_disjoint_caa_mapping_inventory.csv`
- `appendix_group_disjoint_caa_swap_exclusion_decision.csv`
- `appendix_letter_group_cluster_bootstrap_ci.csv`
- `appendix_letter_permutation_bootstrap_ci.csv`
- `appendix_letter_permutation_swap_exclusion_decision.csv`
...
- `main_position_localization_summary.csv`
- `main_position_localization_by_model.csv`
- `main_readout_geometry_concentration.csv`
...
- `appendix_readout_model_summary.csv`
- `appendix_readout_pair_bootstrap_reference.csv`

## Cross-method, mapping balance, and task scope

- `main_cross_method_steering_summary.csv`
- `main_mapping_balanced_factorial_by_model.csv`
- `appendix_cross_method_interface_profile.csv`
...
- `appendix_mapping_balanced_factorial_by_contrast.csv`
- `appendix_mapping_balanced_factorial_identifier_vocabulary.csv`
- `appendix_mapping_balanced_factorial_raw_vs_balanced_group_cluster_ci.csv`
- `appendix_mapping_balanced_factorial_direction_inventory.csv`
- `appendix_mapping_balanced_factorial_key_competence_summary.csv`
- `appendix_mapping_balanced_factorial_paired_contrasts.csv`
- `appendix_mapping_balance_norm_retention_by_model.csv`
...
- `appendix_human_annotation_agreement.csv`
- `appendix_human_annotation_alignment_audit.csv`
- `appendix_human_annotation_final_agreement.csv`
- `appendix_human_annotation_paired_effects.csv`
- `appendix_human_annotation_verdict_agreement.csv`

## Figures

`figures/` contains PNG previews and vector PDF copies of the four quantitative
figures used by the current main paper and supplement. The conceptual overview
is authored separately from these experiment outputs.
